...
var controlSurfaceCompatibility = map[int]string{
	// 30 adds bundle-reclaim: evidence-backed reclamation of owned git
	// transfer bundles (dry run by default; manifest-bound coordinator-only
	// cleanup lifecycle).
	30: "760ed175480b59691abbd346cbaed3643184909d8f0795e73c1d60a90e9c25d7",
