...
const controlSurfaceVersion = 35
...
var controlSurfaceCompatibility = map[int]string{
	// 35 adds artifact-archive: digest-addressed copy of ignored worktree
	// files with a manifest before any removal (FAC-847).
	35: "e4ad8215a9c6d3fe68cbaaa6a0205689dfaec17f206f1f768e2cae95360fe534",
	...
	32: "0bfcb17397b48f6e6999a57708289068fd7c96d3c142b5c896dd2dab94b01a32",
	// 31 shipped on main with the native install registration composed with
	// main's idle-pool registration in one registry state.
	31: "46d8af7eb16b60871e23cb7bf202940a7e9e6861efd4fea88e31ade9c7806400",
	// 30 adds mainline idle-pool: bounded, non-current pool-root discovery and
	...
	// FAC-759: explicit admitted-record recovery from retained native evidence.
	27: "6ffb1d58b3f0b664b11531122bc92f028847f7355a5bf25c1d35467fda0875f5",
