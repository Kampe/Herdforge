...
This separate artifact corrects only the earlier provenance prefill from `builder-family: unrecorded` to `builder-family: xai`; the original artifact remains byte-identical and has SHA-256 `37e907ec4f4bcaf1e2452f2704e2f2e406ce8b9f48643433b303ec23ce3fae85`. The coordinator-supplied primary canonical evidence identifies accepted source row digest `4ee88d48dfbe0d5a9c6c593210692f5e83f8345b2ef8adbcca0fe7820a934342`, with `builder_family: xai` for the accepted `repair/fac-765-authenticated-host-ingest` branch before this candidate, and the native primary refusal explicitly confirms that the earlier `unrecorded` value contradicts that recorded family. Findings and tests below are unchanged.
